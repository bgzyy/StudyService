...
java -Dspring.datasource.url="jdbc:mysql://mysql-81ec6c.pveruntimedev.svc.cluster.local/study_service_24484_zyy?useUnicode=true&characterEncoding=utf-8&useSSL=false" \
